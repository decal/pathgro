...
(define (display-help)
  ...
  (newline)
  (display "  ")
  (display (colorize-string "-G, --Grow" 'BLACK 'ON-GREEN 'BOLD 'UNDERLINE))
  (display "     ")
  (display (colorize-string "MODENM" 'BLACK 'ON-YELLOW 'REVERSE 'UNDERLINE))
  (display "  ")
  (display (colorize-string "various combinations of flags" 'MAGENTA))
  (newline)
  (display "  ")
  ...
  (display (colorize-string "MODENM" 'BLACK 'ON-YELLOW 'REVERSE 'UNDERLINE))
  (display "                 ")
  (display (colorize-string "mode number for combining command-line flags" 'GREEN))
  (newline)
  (display "  ")
  (display (colorize-string "TDEPTH" 'BLACK 'ON-YELLOW 'REVERSE 'UNDERLINE))
  (display "                 ")
