...
(define (display-help)
  ...
  (display "             ")
  (display (colorize-string "i.e. " 'MAGENTA))
  (display (colorize-string "--0Grow" 'MAGENTA 'UNDERLINE 'BOLD))
  (display (colorize-string ", " 'MAGENTA))
  (display (colorize-string "--1Grow" 'MAGENTA 'UNDERLINE 'BOLD))
  (display (colorize-string ", etc. refer to " 'MAGENTA))
  (display (colorize-string "README.md" 'MAGENTA 'UNDERLINE 'BOLD))
  (display (colorize-string " for more info" 'MAGENTA))
  (newline)
  (display "  ")
