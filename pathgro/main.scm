...
(use-modules ((pathgro base pathgro-compute) #:select (pathgro-compute combine-paths combine-files combine-paths-helper combine-files-helper)))
...
(define (debug-print asym)
  (display (symbol->string (quote asym)))
  (display ": ")
  (display asym)
  (newline))
