  ...
  (let* 
    ...
    (cond
      ...
      (opt-Version
        (display-version))
      (else
	(when (or (zero? opt-Grow) opt-0Grow) (begin (srand) (set! opt-basename (rand-truth-value)) (srand) (set! opt-extname (rand-truth-value)) (srand) (set! opt-filename (rand-truth-value)) (srand) (set! opt-dirname (rand-truth-value)) (srand) (set! opt-xtdirname (rand-truth-value)) (srand) (set! opt-macos (rand-truth-value)) (srand) (set! opt-saves (rand-truth-value)) (srand) (set! opt-generate (rand-truth-value)) (srand) (set! opt-vimswap (rand-truth-value))))
        (when (or (= 1 opt-Grow) opt-1Grow) (begin (set! opt-basename #t) (set! opt-extname #t) (set! opt-filename #t)))
        (when (or (= 2 opt-Grow) opt-2Grow) (begin (set! opt-dirname #t) (set! opt-xtdirname #t)))
        (when (or (= 3 opt-Grow) opt-3Grow) (begin (set! opt-basename #t) (set! opt-extname #t) (set! opt-filename #t) (set! opt-dirname #t) (set! opt-xtdirname #t)))
        (when (or (= 4 opt-Grow) opt-4Grow) (begin (set! opt-macos #t) (set! opt-saves #t)))
        (when (or (= 5 opt-Grow) opt-5Grow) (begin (set! opt-generate #t) (set! opt-vimswap #t)))
        (when (or (= 6 opt-Grow) opt-6Grow) (begin (set! opt-macos #t) (set! opt-saves #t) (set! opt-generate #t) (set! opt-vimswap #t)))
        (when (or (= 7 opt-Grow) opt-7Grow) (begin (set! opt-Combos 1) (set! opt-Kperms 1) (set! opt-Traverse 1)))
        (when (or (= 8 opt-Grow) opt-8Grow) (begin (set! opt-basename #t) (set! opt-extname #t) (set! opt-filename #t) (set! opt-dirname #t)
